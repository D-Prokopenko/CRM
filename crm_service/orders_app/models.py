...
class DeviceInField(models.Model):
    ...
    customer = models.ForeignKey(Customer, on_delete=models.RESTRICT, verbose_name="Пользователя")
    analyzer = models.ForeignKey(Device, on_delete=models.RESTRICT, verbose_name="Оборудования")
...
class Order(models.Model):
    ...
    order_status = models.TextField(verbose_name="Статус заявки", choices=status)
