    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analyzer', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='orders_app.device', verbose_name='Оборудования')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='orders_app.customer', verbose_name='Пользователя')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.TextField(choices=[('open', 'открыта'), ('closed', 'закрыта'), ('in prigress', 'в работе'), ('need info', 'нужна информация')], verbose_name='Статус заявки')),
